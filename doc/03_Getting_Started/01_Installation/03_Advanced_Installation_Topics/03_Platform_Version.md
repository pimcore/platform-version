...
For updating to new platform versions (including bugfix updates, major version upgrades, and migration steps), see [Updating Pimcore](../../../02_Pimcore_Platform/05_Updating_Pimcore/README.md).
