...
Data objects store structured data independently from the output channel.
They can be used anywhere in your project, whether you are building web pages, feeding an API, or generating a print catalog.
...
1. In the class editor, right-click on the *Base* node (the root of the layout tree) and select
   *Add Layout Component > Panel*. This is the main container for the product attributes.
