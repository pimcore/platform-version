...
- [Setup and working with Platform Versions](./03_Getting_Started/01_Installation/03_Advanced_Installation_Topics/03_Platform_Version.md)
- [Release Notes](./02_Pimcore_Platform/05_Updating_Pimcore/02_Release_Notes/README.md)

## API tests

End-to-end Docker-based install and boot tests. See
[API Testing](./04_API_Testing/01_API_TESTS.md) for local setup,
