...
Due to changes in TinyMCE’s licensing model, we were required to find a new WYSIWYG editor. After careful we’ve chosen 
[Quill](https://quilljs.com/) as replacement.
...
More Details see Pimcore Documentation (to do)
...
- [Data Importer](https://docs.pimcore.com)
- [Direct Edit](https://docs.pimcore.com)
