...
docker compose exec -T -- php composer require pimcore/platform-version:@dev pimcore/pimcore:2026.1.x-dev pimcore/quill-bundle pimcore/admin-ui-classic-bundle -W
